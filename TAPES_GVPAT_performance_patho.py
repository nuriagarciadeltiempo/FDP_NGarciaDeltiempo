...
plt.title('Precision-Recall Curve Zhang data for Pathogenic prediction')
plt.show()
...
plt.xlabel('Recall')
plt.ylabel('Precision')
plt.title('Precision-Recall Curve ClinGer data for Pathogenic prediction')
plt.show()
...
plt.xlabel('FPS')
plt.ylabel('TPR')
plt.title('ROC-curve for Pathogenic Prediction and Zhang data')
...
plt.xlabel('FPS')
plt.ylabel('TPR')
plt.title('ROC-curve for Pathogenic Prediction and ClinGer data')
plt.legend(loc="lower right")
plt.show()
