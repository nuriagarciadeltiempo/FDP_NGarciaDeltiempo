...
def check_PS4(full_stuff, freq_geno_series, freq_exo_series, PS4_df, number_of_samples):
    if ('WT count' and 'Het count' and 'Hom count') in full_stuff.columns and number_of_samples >= 15:
        ...
        # pd.concat is creating a data frame with the information of the objects and their colum name.
...
def process_df_for_trio(tup_databases, full_stuff):
    ...
    for key, value in tup_databases[12].items(): # don't understand how is iterating
        list_healthy.append(tup_databases[12][key]['m'])  # if mother healthy
        list_healthy.append(tup_databases[12][key]['f']) # if father healthy
        list_affected.append(tup_databases[12][key]['o']) # if offspring affected
